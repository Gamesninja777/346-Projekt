...
Zuerst loggt man sich bei seinem AWS-Konto an. Dann öffnet man dort die CloudShell und lädt über Aktionen -> DAtei hpchladen folgende DAteien hoch:
...
Dann muss man etwa 10s warten und daraufhin hat man eine Analyse des Bildes, die man auch im OutBucket unter s3-buckets -> outbucket finden kann. 


## Worauf soll beachtet wird:

Beim Bild "Test.png" muss der Name zwingend mmit einem Grossbuchstaben beginnen. 
